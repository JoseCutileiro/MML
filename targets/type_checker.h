...
namespace mml
{
  ...
  class type_checker : public basic_ast_visitor
  {
    ...
    std::vector<std::shared_ptr<cdk::basic_type>> _functionRets;
    basic_ast_visitor *_parent;

  public:
    type_checker(std::shared_ptr<cdk::compiler> compiler, cdk::symbol_table<mml::symbol> &symtab, basic_ast_visitor *parent) : basic_ast_visitor(compiler), _symtab(symtab), _parent(parent)
    {
    }
